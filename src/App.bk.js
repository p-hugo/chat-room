...
class App extends Component {
    ...
    componentDidMount() {
        ...
        this.socket.on('chat', (data) => {
            ...
            this.setState({
                messages: [...this.state.messages, {user: data.sender, message: data.message}],
                feedback: false,
            });
                    ...
                    <div className="container">
                        <div className="columns is-multiline is-centered">
                            <div className="column is-3">
                                <div className="field">
                                    <div className="control">
                                        <input value={user} type="text" className="input" id="sender"
                                               onChange={evt => this.updateUser(evt)} placeholder="Your Name"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="column">
                                <button className="button is-primary" id="btn" onClick={this.sendMessage}>
                                    Send
                                </button>
                            </div>
                        </div>
